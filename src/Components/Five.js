    ...
    <div>
      <div className="flex overflow-y-auto gap-6 p-6 md:overflow-hidden flex-row items-center justify-start md:justify-center h-[450px] ">
        ...
        >
          ...
          <button className="py-2 px-4 hover:text-white text-black transition-transform duration-200 bg-yellow-400 rounded-md hover:bg-neutral-800 ">
            Know More
          </button>
        </div>
        <div
        ...
        >
          ...
          <button className="py-2 px-4 text-black transition-transform duration-200 bg-yellow-400 rounded-md hover:bg-neutral-800 hover:text-white">
            Know More
          </button>
        </div>
        <div
